...
python3 -m verl.trainer.main \
    ...
    worker.rollout.n=16 \
    worker.rollout.retrieval_model_path=${api_url} \
    ...
    worker.rollout.retrieval_corpus_doc=retrieval_corpus_doc \
    worker.rollout.retrieval_batch_size=2000 \
    worker.rollout.retrieval_topk=10 \
    worker.rollout.retrieval_score_func=dot_score \
    worker.rollout.rollout_mode=two_turn_balanced \
    worker.reward.reward_function=./examples/reward_function/retrieval_two_turn.py:compute_score \
    worker.reward.retrieval_model_path=${api_url} \
    worker.reward.retrieval_corpus_emb_path=retrieval_corpus_emb_path.pt \
    worker.reward.retrieval_lookup_table_path=retrieval_lookup_table_path.json \
    worker.reward.retrieval_batch_size=2000 \
