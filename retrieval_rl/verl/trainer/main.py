...
from ..workers.reward import BatchFunctionRewardManager, SequentialFunctionRewardManager, RetrievalRewardManager
...
class Runner:
    ...
    def run(self, config: PPOConfig):
        ...
        elif config.worker.reward.reward_type == "retrieval":
            RewardManager = RetrievalRewardManager
        else:
